...
import pageFlipSound from "../reactAssest/pageFlip.mp3";
import { Document, Page } from "react-pdf/dist/esm/entry.webpack";
import file from "../reactAssest/file2.pdf";
...
const Book = () => {
  ...
  const [pageHeight, setPageHeight] = useState(595);
  ...
  return (
    <>
      ...
      <audio ref={audioRef} className="audio" src={pageFlipSound}></audio>
    </>
  );
};
