                    ...
                    <div class="col-xxl-6">
                        <div class="card">
                            <div class="card-header align-items-center d-flex">
                                <h4 class="card-title mb-0 flex-grow-1">تعديل الكتاب  </h4>
                                        ...
                                        <div class="card">
                                            ...
                                            <div class="card-body">
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" class="form-control" disabled name="ISBN" id="ISBN" disabled value="{{ $Books->ISBN }}"  placeholder="978xxxxxxxxxx">
                                                </div>
                                                <div class="mb-3">
                                                    <label class="form-label" for="project-title-input">    عنوان الكتاب     </label>
                                                    <input type="text" class="form-control" disabled name="title" value="{{ $Books->title }}" id="title" class="input" required placeholder="اكتب عنوان الكتاب" >
                                                </div>


                                                <div class="mb-3">
                                                    <label for="categories" class="form-label" >القسم</label>
                                                    <select disabled name="categories"  id="categories" class="form-select" data-choices="" data-choices-search-false="" >
                                                        <option value="">{{ $Books->Category->name }}</option>
                                                    </select>
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <select disabled name="school_id"  id="school_id" class="form-select" data-choices="" data-choices-search-false="" >
                                                        <option value="">{{ $Books->School->name }}</option>
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <select  disabled name="lang"  id="lang" required class="form-select" data-choices="" >
                                                        <option value="">{{ $Books->language }}</option>
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" class="form-control" disabled value="{{ $Books->author }}"  name="author" id="author" class="input" required placeholder="اكتب  اسم المؤلف " >
                                                </div>


                                                <div class="mb-3">
                                                    <label for="categories" class="form-label" > عدد الصفحات </label>
                                                    <input type="text" name="page_number" id="page_number"  value="{{ $Books->page_number }}"   class="form-control" disabled required placeholder="اكتب  عدد الصفحات " />
                                                </div>


                                                <div class="mb-3">
                                                    <label for="categories" class="form-label" >  دار النشر </label>
                                                    <input type="text" name="Publishing_House"  value="{{ $Books->Publishing_House }}"  id="Publishing_House" required class="form-control" disabled placeholder="اكتب دار النشر " />
                                                </div>
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <div class="">
                                                    <input type="radio" name="copy" value="paper"  @if ($Books->copy == 'paper')
                                                    checked
                                                    @endif  id="copy">
                                                    <label for="paper">
                                                        نسخة ورقي
                                                ...
                                                <div class="">
                                                    <input type="radio" name="copy" value="electronic"   @if ($Books->copy == 'electronic')
                                                    checked
                                                    @endif    id="copy">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <div class="">
                                                    <input type="radio" name="challenge" value="1"   @if ($Books->challenge == 1)
                                                    checked
                                                    @endif   id="paper">
                                                    <label for="paper">
                                                    تفعيل
                                                ...
                                                <div class="">
                                                    <input type="radio"  name="challenge" value="0"  @if ($Books->challenge == 0)
                                                    checked
                                                    @endif    id="paper">
                                                    <label for="paper">
                                                    تعطيل
