                                        ...
                                        <div class="card">
                                            ...
                                            <div class="card-body">
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" class="form-control" name="title" value="{{ $Books->title }}" id="title" class="input" required placeholder="اكتب عنوان الكتاب" >
                                                </div>
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" class="form-control" value="{{ $Books->author }}"  name="author" id="author" class="input" required placeholder="اكتب  اسم المؤلف " >
                                                </div>


                                                <div class="mb-3">
                                                    <label for="categories" class="form-label" > عدد الصفحات </label>
                                                    <input type="text" name="page_number" id="page_number"  value="{{ $Books->page_number }}"   class="form-control" required placeholder="اكتب  عدد الصفحات " />
                                                </div>


                                                <div class="mb-3">
                                                    <label for="categories" class="form-label" >  دار النشر </label>
                                                    <input type="text" name="Publishing_House"  value="{{ $Books->Publishing_House }}"  id="Publishing_House" required class="form-control" placeholder="اكتب دار النشر " />
                                                </div>
