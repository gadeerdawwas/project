                                                ...
                                                <table class="table align-middle table-nowrap mb-0" id="customerTable">
                                                    <thead class="table-light">
                                                        <tr>
                                                            ...
                                                            <th class="sort" data-sort="name" scope="col">  اسم معلم  </th>
                                                            <th class="sort" data-sort="owner" scope="col">  الايميل   </th>
                                                                ...
                                                                <td>
                                                                    <ul class="list-inline hstack gap-2 mb-0">
                                                                        ...
                                                                        <div class="modal fade"
                                                                            id="editModal{{ $Teacher->id }}" tabindex="-1"
                                                                            ...
                                                                            <div class="modal-dialog modal-dialog-centered">
                                                                                <div class="modal-content">
                                                                                    ...
                                                                                    <form
                                                                                        action="{{ route('manager.teachers.update', $Teacher->id) }}"
                                                                                        method="POST"
                                                                                        ...
                                                                                        <div class="modal-body">
                                                                                            ...
                                                                                            <div class="col-lg-12">
                                                                                                ...
                                                                                                <input type="text" name="name" class="form-control" value="{{$Teacher->name }}" id="name" placeholder="اكتب اسم المعلم الكامل" />
                                                                                            </div>
                                                                                            <div class="col-lg-12">
                                                                                                <label for="email" class="form-label" >البريد الالكتروني</label>
                                                                                                <input type="email" id="email" name="email" value="{{$Teacher->email }}" class="form-control" placeholder="example@gmail.com" />
                                                                                            </div>
                                                                                            ...
                                                                                            <div class="col-lg-12">
                                                                                                ...
                                                                                                <select name="school_id"  id="school_id" class="form-select" data-choices="" data-choices-search-false="" >
                                                                                                    @foreach ($Schools as $School)
                                                                                                        <option @if ( $School->id == $Teacher->school_id)
                                                                                                            selected
                                                                        ...
                                                                        <div class="modal fade zoomIn" id="deleteModal{{ $Teacher->id }}"
                                                                            ...
                                                                            <div class="modal-dialog modal-dialog-centered">
                                                                                <div class="modal-content">
                                                                                    ...
                                                                                    <div class="modal-body p-5 text-center">
                                                                                        ...
                                                                                        <form
                                                                                            action="{{ route('manager.teachers.destroy', $Teacher->id) }}"
                                                                                            method="post">
                                                                                            @csrf
                                                                                            @method('delete')
                ...
                <div class="modal fade" id="addModal" tabindex="-1" aria-labelledby="exampleModalLabel"
                    ...
                    <div class="modal-dialog modal-dialog-centered">
                        <div class="modal-content border-0">
                            ...
                            <form action="{{ route('manager.teachers.store') }}" method="POST" enctype="multipart/form-data">
                                <div class="modal-body">
                                    @csrf
