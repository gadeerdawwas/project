...
@section('content')
    <div class="main-content">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                            <h4 class="mb-sm-0">أقسام الكتب  </h4>

                            <div class="page-title-right">
                                <ol class="breadcrumb m-0">
                                    <li class="breadcrumb-item"><a href="javascript: void(0);">لوحة التحكم</a></li>
                                    <li class="breadcrumb-item active">أقسام الكتب  </li>
                                </ol>
                            </div>
                                ...
                                <div class="d-flex align-items-center flex-wrap gap-2">
                                    <div class="flex-grow-1">
                                        <button class="btn btn-info add-btn" data-bs-toggle="modal"
                                            data-bs-target="#addModal"><i class="ri-add-fill me-1 align-bottom"></i> إضافة
                                            قسم  </button>
                                                ...
                                                <table class="table align-middle table-nowrap mb-0" id="customerTable">
                                                    <thead class="table-light">
                                                        <tr>
                                                            ...
                                                            <th class="sort" data-sort="name" scope="col">اسم قسم </th>
                                                                ...
                                                                <td>
                                                                    <div class="d-flex align-items-center">
                                                                        ...
                                                                        <div class="flex-grow-1 ms-2 name">
                                                                            ...
                                                                            height: 50px;"
                                                                            src="{{ asset($category->image) }}" class="jet-banner__img" alt="36254sd"
                                                                            loading="lazy">
                                                                        </div>
                                                                ...
                                                                <td>
                                                                    <ul class="list-inline hstack gap-2 mb-0">
                                                                        ...
                                                                        <div class="modal fade"
                                                                            id="editModal{{ $category->id }}" tabindex="-1"
                                                                            ...
                                                                            <div class="modal-dialog modal-dialog-centered">
                                                                                <div class="modal-content">
                                                                                    ...
                                                                                    <form
                                                                                        action="{{ route('manager.categories.update', $category->id) }}"
                                                                                        method="POST"
                                                                                        ...
                                                                                        <div class="modal-body">
                                                                                            ...
                                                                                            <div class="col-lg-12">
                                                                                                <div>
                                                                                                    <label for="name-field" class="form-label"> صورة القسم </label>
                                                                                                    <input type="file" id="customername-field" class="form-control"
                                                                                                       name="image"  />
                                                                        ...
                                                                        <div class="modal fade zoomIn" id="deleteModal{{ $category->id }}"
                                                                        ...
                                                                        <div class="modal-dialog modal-dialog-centered">
                                                                            <div class="modal-content">
                                                                                ...
                                                                                <div class="modal-body p-5 text-center">
                                                                                    ...
                                                                                    <form
                                                                                        action="{{ route('manager.categories.destroy', $category->id) }}"
                                                                                        method="post">
                                                                                        @csrf
                                                                                        @method('delete')
                ...
                <div class="modal fade" id="addModal" tabindex="-1" aria-labelledby="exampleModalLabel"
                    ...
                    <div class="modal-dialog modal-dialog-centered">
                        <div class="modal-content border-0">
                            ...
                            <form action="{{ route('manager.categories.store') }}" method="POST" enctype="multipart/form-data">
                                <div class="modal-body">
                                    @csrf
                                    ...
                                    <div class="row g-3">
                                        <div class="col-lg-12">
                                            <div>
                                                <label for="name-field" class="form-label">اسم القسم </label>
                                                <input type="text" id="customername-field" class="form-control"
                                                    placeholder="ادخل اسم القسم  " name="name" required />
                                            </div>
                                        </div>
                                        <div class="col-lg-12">
                                            <div>
        ...
        @push('script')
            ...
            <script src="{{ asset('dashboard/assets/js/pages/crm-الاقسام .init.js') }}"></script>
        @endpush
