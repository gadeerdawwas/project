...
<!-- Mirrored from themesbrand.com/velzon/html/default/auth-signin-basic.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 11 Feb 2022 20:44:52 GMT -->
<head>
                            ...
                            <div class="text-center  ">
                                <div>
                                    <a href="#" class="d-inline-block auth-logo">
                                        <img src="{{ asset('site/assets/images/white-logo.svg') }}" alt="" height="100">
                                    </a>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card mt-4">
                                ...
                                <div class="card-body p-4" style="direction: rtl;">
                                    <div class="text-center mt-2">
                                        ...
                                        <h5 class="text-primary" style="font-family: system-ui;
                                        color: #698954  !important;
                                        font-weight: 500;">
                                            تسجيل دخول
                                        </h5>
                                        <h5 class="text-primary" style="font-family: system-ui;
                                    ...
                                    <div class="p-2 mt-4">
                                        <form action="{{ route('adminLogin') }}" method="POST">
                                            ...
                                            <div class="mb-3">
                                                <label for="username" class="form-label"> اسم مستخدم </label>
                                            ...
                                            <div class="mt-4">
                                                <button class="btn btn-success w-100" type="submit">تسجيل دخول</button>
                                            </div>
...
<!-- Mirrored from themesbrand.com/velzon/html/default/auth-signin-basic.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 11 Feb 2022 20:44:53 GMT -->
</html>
