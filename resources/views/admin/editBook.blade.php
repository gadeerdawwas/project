...
<div class="w-full bg-white py-10 px-5 h-screen">
    ...
    <div class="w-full h-auto pb-8">
        <div class="relative overflow-x-clip shadow-md sm:rounded-lg p-3 bg-yellow-200">
            ...
            <form action="{{ route('updatebook_admin',$book->id) }}" method="post" enctype="multipart/form-data">
                @csrf
                {{-- <div class="mb-3">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="ISBN" class="input" disabled value="{{ $book->ISBN }}" placeholder="اكتب رقم ردمك " />
                </div>
                <div class="mb-3">
                ...
                <div class="mb-3">
                    ...
                    <select class="input" name="language" id="categories">
