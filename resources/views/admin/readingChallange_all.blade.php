...
<div class="w-full bg-white py-10 px-5 h-screen">
    ...
    <div class="row justify-content-md-center bg-danger mt-3 p-6">
        <div class="col-lg-6   ">
            <a href="{{ route('readChallange_group_user',['id' => 1, 'parameter' => $user_id]) }}" style="color: #000" class="">
    ...
    <div class="row justify-content-md-center bg-success  mt-3 p-6">
        <div class="col-lg-6   ">
            <a href="{{ route('readChallange_group_user',['id' => 2, 'parameter' => $user_id]) }}" style="color: #000" class="">
    ...
    <div class="row justify-content-md-center bg-primary mt-3 p-6">
        <div class="col-lg-6   ">
            <a href="{{ route('readChallange_group_user',['id' => 3, 'parameter' => $user_id]) }}" style="color: #000" class="">
    ...
    <div class="row justify-content-md-center bg-secondary mt-3 p-6">
        <div class="col-lg-6   ">
            <a href="{{ route('readChallange_group_user',['id' => 4, 'parameter' => $user_id]) }}" style="color: #000" class="">
    ...
    <div class="row justify-content-md-center bg-Gold mt-3 p-6" style="    background: gold;">
        <div class="col-lg-6   ">
            <a href="{{ route('readChallange_group_user',['id' => 5, 'parameter' => $user_id]) }}" style="color: #000" class="">
