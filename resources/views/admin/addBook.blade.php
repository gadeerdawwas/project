        ...
        <div class="relative overflow-x-clip shadow-md sm:rounded-lg p-3 bg-yellow-200">
            ...
            <form action="" method="post" enctype="multipart/form-data">
                ...
                <div class="mb-3">
                    ...
                    <input type="text"   name="ISBN"  class="input"   placeholder="978xxxxxxxxxx"  />
{{--
                    <input type="text"   name="ISBN"  class="input"   required placeholder="978xxxxxxxxxx" minlength="10" maxlength="13" /> --}}
