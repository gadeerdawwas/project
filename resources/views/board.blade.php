...
<body class="bg-white">
    ...
    <div class="flex">
        ...
        <aside class="w-72 " aria-label="Sidebar">
            <div class="roverflow-y-visible h-screen py-4 px-3 bg-gray-100 rounded dark:bg-gray-800">
                <ul class="space-y-2">
                    <li>
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 via-red-500 inline" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                            <path stroke-linecap="round" stroke-linejoin="round" d="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253" />
                        </svg>
                        <span>المكتبات الإلكترونية</span>
                    </li>
                    <li>
                    ...
                    <li>
                        <a href="#" class="flex items-center p-2 text-base font-normal text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700">
                            ...
                            <span class="flex-1 mr-3 whitespace-nowrap">Kanban</span>
        ...
        <!-- content -->
        <div class="w-full bg-slate-300 py-10 px-5 h-screen">
            <h1>hello</h1>
        </div>
